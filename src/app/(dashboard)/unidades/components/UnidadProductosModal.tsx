...
interface UnidadProductosModalProps {
  isOpen: boolean;
  unidad?: Unidad;
  onClose: () => void;
}

export function UnidadProductosModal({
  isOpen,
  unidad,
  onClose,
}: UnidadProductosModalProps) {
  if (!isOpen || !unidad) return null;

  const productos = unidad.productos || [];
        ...
        <div className="flex items-center justify-between border-b border-slate-800 p-6">
          <div>
            <h2 className="text-xl font-bold text-white">
              Productos en "{unidad.nombre}" ({unidad.abreviatura})
            </h2>
                  ...
                  {productos.map((producto: any) => (
                    ...
                    >
                      ...
                      <td className="px-6 py-4 text-right">
                        ...
                        >
                          {producto.stock} {unidad.abreviatura}
                        </span>
                      </td>
                    </tr>
                  ))}
